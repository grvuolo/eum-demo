...
module.exports = {
    ...
    reporting: {
        marketingtemp: {
            apiKey: 'sTI3cWlmSSC_TC6vl8N_-g',
            url: 'https://eum-blue-saas.instana.io/'
        },
        sesandbox: {
            apiKey: 'AZMDhwuBTQmttjNKDh8UsA',
            url: 'https://eum-red-saas.instana.io/'
        },
        demoeu: {
            apiKey: 'YVsbO7YxRF2JSRLhmA19_Q',
            url: 'https://eum-blue-saas.instana.io/'
        },
        demous: {
            apiKey: '23nOMgOLRwmnvF6iS3-Ahw',
            url: 'https://eum-red-saas.instana.io/'
        },
        partner: {
            apiKey: '-DQ9_8zpSGuC268x0J0rgw',
            url: 'https://eum-blue-saas.instana.io/'
        },
        training: {
            apiKey: 'xDrF6d2GTHeI-TbCKs8OQg',
            url: 'https://eum-red-saas.instana.io/'
        },
        ibmdemo: {
            apiKey: 'tqZy9wNjT9ioKWyP4mNrgA',
    ...
    pages: [
        ...
        },
        {
            ...
            weightpct: 100,
            backend: [
                'http://web.robot-shop:8080/api/catalogue/products',
                'http://web.robot-shop:8080/api/ratings/api/fetch/STAN-1'
            ],
            ajax: [ ],
            error: {
